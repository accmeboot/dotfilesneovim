-- vim.g.gruvbox_material_background = "soft" --hard, medium (default) and soft
...
-- vim.g.sonokai_background = "soft" --hard, medium (default) and soft
-- vim.g.sonokai_foreground = "material" -- material, mix, original
vim.g.sonokai_better_performance = 1 --For Better Performance
vim.g.sonokai_transparent_background = 2 -- 0, 1 or 2
-- vim.g.sonokai_statusline_style = "original" -- default, mix, original
